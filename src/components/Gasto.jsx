function Gasto() {
    return ( 
        <div className="bg-white p-6 border grid grid-cols-5 grid-rows-2 my-auto gap-1">
            <h2 className="font-black text-xl md:text-3xl col-span-3 sm:col-span-3 self-center">Suscripción a Spotify</h2>
            <p className="font-black text-xl md:text-3xl col-span-2 sm:col-span-2 text-end self-center">$1,269.00</p>
